  ...
  return (
    <div className="min-h-screen flex flex-col">
      ...
      <div className="gradient-islamic islamic-pattern px-5 pb-10 pt-16 text-center relative">
        ...
        >
          <h1 className="text-4xl font-bold font-arabic text-primary-foreground mb-2">أذاني</h1>
          <p className="text-primary-foreground/70 text-sm">تطبيقك الإسلامي الشامل</p>
        </motion.div>
      ...
      <div className="flex-1 px-5 pt-4 max-w-md mx-auto w-full">
        ...
        >
          <Button
            ...
            variant="outline"
            className="w-full rounded-xl h-12 gap-3 text-foreground mb-6"
          >

...
const arabicStrings: Record<string, string> = {
  ...
  storyContent: 'اكتب قصتك هنا...',
  selectCategory: 'القسم:',
  smartCategory: 'تصنيف ذكي',
  addImage: 'صورة',
  addVideo: 'فيديو',
  uploading: 'جاري الرفع...',
  published: 'تم النشر! ✨',
  writeTitle: 'اكتب العنوان والقصة',
  comments: 'تعليقات',
  ...
  askAboutReligion: 'اسأل عن دينك',
  shop: 'المتجر',
  featuredItems: 'عناصر مميزة',
  marketplace: 'السوق',
  islamicProducts: 'منتجات إسلامية',
  ...
  donations: 'التبرعات والمساعدة',
  helpNeedy: 'ساعد المحتاجين - ادعُ لوالديّ',
  logout: 'تسجيل الخروج',
  ...
  // Ruqyah section
  ruqyah: 'الرقية',
  ruqyahSection: 'قسم الرقية الشرعية',
  ...
  accountCreateError: 'حدث خطأ أثناء إنشاء الحساب',
  enterEmail: 'أدخل بريدك الإلكتروني',
  resetLinkSent: 'تم إرسال رابط إعادة التعيين',
  forgotPassword: 'نسيت كلمة المرور',
  enterEmailToRecover: 'أدخل بريدك لاستعادة حسابك',
  sendResetLink: 'إرسال رابط الاستعادة',
  backToLogin: 'العودة لتسجيل الدخول',
  companionApp: 'رفيقك الروحي في كل وقت',
  ...
  // Prayer Times
  prayerTimesSource: 'مواقيت الصلاة',
  prayerTimesCopied: 'تم نسخ مواقيت الصلاة',
  mosqueTimes2: 'أوقات المسجد',
  mosqueUnlinked2: 'تم إلغاء ربط المسجد',
  unlinkLabel: 'إلغاء',
  todayPrayerTimes: 'أوقات الصلاة اليوم',
  nextPrayerIs: 'الصلاة القادمة',
  timeLeft: 'متبقي',
  changeMosque: 'تغيير المسجد',
  chooseYourMosque: 'اختر مسجدك',
  searchNearbyMosque: 'ابحث عن مسجدك القريب واختر أوقاته',

  // Stories
  now: 'الآن',
  loginFirst: 'سجّل دخولك أولاً',
  story: 'قصة',
  shared: 'تمت المشاركة',
  pullDown: 'اسحب',
  comment: 'تعليق',
  ...
  aiCategorized: 'تم التصنيف بالذكاء الاصطناعي',
  ...
  speakNow: 'تحدّث الآن... ابحث عن قصة',
  voiceNotRecognized: 'لم يتم التعرف على الصوت، حاول مرة أخرى',
  searchStoryOrAuthor: 'ابحث عن قصة أو كاتب',
  listening: 'جاري الاستماع...',
  saySomethingLike: 'قل مثلاً',
  istighfarStoryExample: 'أريد قصة عن الاستغفار',
  mostViewed: 'الأكثر مشاهدة',
  storiesEveryoneReads: 'القصص التي يقرأها الجميع',
  showLess: 'عرض أقل',
  showMore: 'المزيد',
  mostInteracted: 'الأكثر تفاعلاً',
  touchedHearts: 'قصص أثرت في القلوب',
  noContentYet: 'لا يوجد محتوى بعد',
  publishFirstStoryInspire: 'انشر قصتك وكن أول من يلهم الآخرين',
  publishFirst: 'انشر أول قصة',
  goBack: 'العودة',
  ...
  loginForProfile: 'سجّل دخولك للوصول لملفك الشخصي وقصصك',
  user: 'مستخدم',
  prophets: 'الأنبياء',
  companions: 'الصحابة',
  rizq: 'الرزق',
  ...
  follow: 'متابعة',
  myStories: 'حكاياتي',
  savedStories: 'المحفوظات',
  likedStories: 'الإعجابات',
  noStoriesYetProfile: 'لا توجد قصص بعد',
  assistant: 'المساعد',

  // Tasbeeh
  rememberAllah: 'اذكر الله وسبّحه',
  resetCounter: 'إعادة تعيين العداد؟',
  chooseDhikr: 'اختر الذكر',
  chooseFromAdhkar: 'اختر من الأذكار المأثورة',

  // Qibla
  howToUseCompass: 'كيف تستخدم البوصلة',
  placePhoneFlat: 'ضع الهاتف بشكل أفقي مسطّح',
  onYourPalm: 'على راحة يدك',
  awayFromMetals: 'ابتعد عن المعادن والأجهزة الإلكترونية',
  headphonesLaptop: 'سماعات، لابتوب',
  calibrateCompass: 'لمعايرة البوصلة: حرّك الهاتف بشكل رقم 8',
  severalTimes: 'عدة مرات',
  turnBodyUntil: 'أدِر جسمك حتى تظهر في الأعلى',
  turnsGreen: 'ويتحول اللون إلى أخضر',
  understood: 'فهمت',
  tapToActivate: 'اضغط هنا لتفعيل البوصلة',
  compassNotAvailable: 'البوصلة غير متاحة',
  compassNotSupported: 'جهازك لا يدعم البوصلة الرقمية أو أنك تستخدم متصفح كمبيوتر. استخدم الزاوية المعروضة مع بوصلة خارجية أو تطبيق خرائط.',
  calibrate: 'معايرة',
  lowAccuracy: 'دقة البوصلة منخفضة - حرّك الهاتف بشكل رقم 8',
  locationNotDetected: 'لم يتم تحديد موقعك - فعّل خدمات الموقع',
  thisIsQiblaDirection: 'هذا اتجاه القبلة',
  highAccuracy: 'دقة عالية',
  mediumAccuracy: 'دقة متوسطة',
  lowAccuracyCalibrate: 'دقة منخفضة - يرجى المعايرة',

  // Zakat
  realEstateCommercial: 'العقارات والممتلكات التجارية',
  smartMultiCurrencyCalc: 'حاسبة ذكية متعددة العملات',
  currency: 'العملة',
  chooseCurrency: 'اختر عملة بلدك لحساب النصاب',
  detecting: 'جاري التحديد...',
  chooseCurrencyBtn: 'اختر العملة',
  nisabIn: 'نصاب الزكاة بـ',
  goldGrams: 'ذهب (85 غرام)',
  silverGrams: 'فضة (595 غرام)',
  approvedNisab: 'النصاب المعتمد',
  yourAssets: 'أصولك ومدخراتك',
  enterAssetValues: 'أدخل قيمة كل نوع من الأصول بالعملة المختارة',
  ...
  belowNisabMsg: 'أموالك أقل من النصاب',
  shariaNote: 'ملاحظة شرعية',
  zakatNoteText: 'تعتمد هذه الحاسبة على نصاب الفضة (595 غرام) وهو الأقل، وذلك لمصلحة الفقراء وفق رأي جمهور العلماء. نسبة الزكاة الثابتة هي 2.5% من إجمالي المال الذي بلغ النصاب ومرّ عليه حول كامل.',

  // Account
  photoUploaded: 'تم رفع الصورة',
  photoUploadFailed: 'فشل رفع الصورة',
  uploadError: 'خطأ في الرفع',
  nameRequired: 'يجب كتابة الاسم',
  ...
  leaveEmptyNoChange: 'اترك فارغاً إذا لا تريد التغيير',
  minSixChars: 'يجب أن تكون 6 أحرف على الأقل',
  saveChanges: 'حفظ التعديلات',

  // AI Assistant
  islamicAssistant: 'المساعد الإسلامي',
  aiAssistantDesc: 'مساعد ذكي مدعوم بـ GPT-5.2 متخصص في الأسئلة الإسلامية',
  poweredBy: 'مدعوم بـ',
  free: 'مجاني',
  question: 'سؤال',
  questionsLeft: 'متبقي',
  askMeAnything: 'اسألني أي سؤال إسلامي',
  taraweehRuling: 'ما حكم صلاة التراويح؟',
  zakatCalcQuestion: 'كيف أحسب زكاة المال؟',
  pillarsOfIslam: 'ما هي أركان الإسلام؟',
  mosqueEntryDua: 'دعاء دخول المسجد',
  watchVideosForPoints: 'شاهد فيديوهات لكسب نقاط مجانية',
  writeYourQuestion: 'اكتب سؤالك الإسلامي...',

  // Rewards
  dailyCheckIn: 'تسجيل يومي',
  dailyCheckInDesc: 'سجّل دخولك يومياً واحصل على مكافأة',
  tasbeehReward: 'تسبيح',
  complete100Tasbeeh: 'أكمل 100 تسبيحة',
  quranPage: 'صفحة قرآن',
  readQuranPage: 'اقرأ صفحة من القرآن',
  mustLogin: 'يجب تسجيل الدخول',
  yourBalance: 'رصيدك',
  dayStreak: 'سلسلة أيام',
  totalEarned: 'إجمالي',
  collectRewards: 'اجمع المكافآت',
  collect: 'استلم',
  storeSection: 'المتجر',
  buyWithGold: 'اشترِ عناصر مميزة بالذهب',
  history: 'السجل',
  ...
  athanNotifications: 'إشعارات الأذان',

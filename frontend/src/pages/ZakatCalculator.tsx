...
const COUNTRY_CURRENCIES: Record<string, { code: string; symbol: string; name: string }> = {
  ...
  OM: { code: 'OMR', symbol: 'ر.ع', name: 'Omani Riyal' },
  YE: { code: 'YER', symbol: 'ر.ي', name: 'Yemeni Riyal' },
  EG: { code: 'EGP', symbol: 'ج.م', name: 'Egyptian Pound' },
  JO: { code: 'JOD', symbol: 'د.أ', name: 'Jordanian Dinar' },
  LB: { code: 'LBP', symbol: 'ل.ل', name: 'Lebanese Lira' },
  SY: { code: 'SYP', symbol: 'ل.س', name: 'Syrian Lira' },
  IQ: { code: 'IQD', symbol: 'ع.د', name: 'Iraqi Dinar' },
  LY: { code: 'LYD', symbol: 'د.ل', name: 'Libyan Dinar' },
  ...
  PS: { code: 'ILS', symbol: '₪', name: 'Shekel' },
  ...
  DE: { code: 'EUR', symbol: '€', name: t('euro') },
  FR: { code: 'EUR', symbol: '€', name: t('euro') },
  NL: { code: 'EUR', symbol: '€', name: t('euro') },
  BE: { code: 'EUR', symbol: '€', name: t('euro') },
  IT: { code: 'EUR', symbol: '€', name: t('euro') },
  ES: { code: 'EUR', symbol: '€', name: t('euro') },
  AT: { code: 'EUR', symbol: '€', name: t('euro') },
...
export default function ZakatCalculator() {
  ...
  const currencyInfo = useMemo(() => {
    ...
    return entry || { code: 'USD', symbol: '$', name: 'US Dollar' };
  }, [selectedCurrency]);

...
const NOOR_MESSAGES: Record<string, Record<string, string>> = {
  greeting: {
    ...
    'de-AT': 'Grüß Gott! Ich bin Noor, dein Freund beim Arabisch lernen!',
  ...
  correct: {
    ...
    'de-AT': 'Super gemacht! Richtige Antwort! ⭐',
  ...
  wrong: {
    ...
    'de-AT': 'Kein Problem, probier\'s nochmal! 💪',
  ...
  encourage: {
    ...
    'de-AT': 'Weiter so! Du bist echt super! 🌟',
  ...
  letterIntro: {
    ...
    'de-AT': 'Komm, lernen wir einen neuen Buchstaben!',

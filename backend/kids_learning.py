...
KIDS_HADITHS = [
    {"id": 1, "category": "kindness", "emoji": "💖",
     ...
     "en": "The merciful are shown mercy by the Most Merciful. Be merciful to those on earth and the One in heaven will be merciful to you",
     "de": "Die Barmherzigen erfahren Barmherzigkeit vom Allerbarmer. Seid barmherzig zu denen auf der Erde, und der im Himmel wird barmherzig zu euch sein",
     "fr": "Les miséricordieux reçoivent la miséricorde du Très Miséricordieux. Soyez miséricordieux envers ceux sur terre et Celui au ciel sera miséricordieux envers vous",
     "tr": "Merhametli olanlara Rahman merhamet eder. Yeryüzündekilere merhamet edin ki gökteki de size merhamet etsin",
     "ru": "Милосердным являет милость Милостивый. Будьте милосердны к тем, кто на земле, и Тот, Кто на небе, будет милосерден к вам",
     "source": "الترمذي", "narrator": "عبد الله بن عمرو",
     "lesson": {"ar": "كن رحيماً مع الناس والحيوانات", "en": "Be kind to people and animals", "de": "Sei freundlich zu Menschen und Tieren", "fr": "Sois gentil avec les gens et les animaux", "tr": "İnsanlara ve hayvanlara karşı merhametli ol", "ru": "Будь добр к людям и животным"}},
    ...
    {"id": 3, "category": "smile", "emoji": "😊",
     ...
     "en": "Your smile for your brother is a charity",
     "de": "Dein Lächeln für deinen Bruder ist eine Wohltätigkeit",
     "fr": "Ton sourire à ton frère est une aumône",
     "tr": "Kardeşinin yüzüne gülümsemen sadakadır",
     "ru": "Твоя улыбка брату твоему — милостыня",
     "source": "الترمذي", "narrator": "أبو ذر",
     "lesson": {"ar": "ابتسم دائماً", "en": "Always smile", "de": "Lächle immer", "fr": "Souris toujours", "tr": "Her zaman gülümse", "ru": "Всегда улыбайся"}},
    {"id": 4, "category": "manners", "emoji": "🤝",
     ...
     "lesson": {"ar": "تكلم بالخير أو اسكت", "en": "Speak good or stay silent", "de": "Sprich Gutes oder schweige", "fr": "Dis du bien ou tais-toi", "tr": "Ya hayır söyle ya sus", "ru": "Говори доброе или молчи"}},
    {"id": 5, "category": "cleanliness", "emoji": "🧼",
     ...
     "lesson": {"ar": "حافظ على نظافتك", "en": "Keep yourself clean", "de": "Halte dich sauber", "fr": "Reste propre", "tr": "Temizliğine dikkat et", "ru": "Содержи себя в чистоте"}},
    {"id": 6, "category": "neighbors", "emoji": "🏘️",
     ...
     "lesson": {"ar": "أحسن إلى جيرانك", "en": "Be good to your neighbors", "de": "Sei gut zu deinen Nachbarn", "fr": "Sois bon envers tes voisins", "tr": "Komşularına iyi davran", "ru": "Будь добр к соседям"}},
    {"id": 7, "category": "knowledge", "emoji": "📖",
     ...
     "ru": "Поиск знаний — обязанность каждого мусульманина",
     "source": "ابن ماجه", "narrator": "أنس بن مالك",
     "lesson": {"ar": "تعلم كل يوم شيئاً جديداً", "en": "Learn something new every day", "de": "Lerne jeden Tag etwas Neues", "fr": "Apprends quelque chose de nouveau chaque jour", "tr": "Her gün yeni bir şey öğren", "ru": "Учись чему-то новому каждый день"}},
    {"id": 8, "category": "nature", "emoji": "🌱",
     ...
     "lesson": {"ar": "ازرع واعتنِ بالبيئة", "en": "Plant trees and care for the environment", "de": "Pflanze Bäume und kümmere dich um die Umwelt", "fr": "Plante des arbres et prends soin de l'environnement", "tr": "Ağaç dik ve çevreye özen göster", "ru": "Сажай деревья и заботься об окружающей среде"}},
    {"id": 9, "category": "patience", "emoji": "🌟",
     ...
     "lesson": {"ar": "كن إيجابياً دائماً", "en": "Always be positive", "de": "Sei immer positiv", "fr": "Sois toujours positif", "tr": "Her zaman olumlu ol", "ru": "Всегда будь позитивным"}},
    {"id": 10, "category": "food", "emoji": "🥘",
     ...
     "lesson": {"ar": "لا تبذر في الطعام", "en": "Don't waste food", "de": "Verschwende kein Essen", "fr": "Ne gaspille pas la nourriture", "tr": "Yiyeceği israf etme", "ru": "Не трать еду впустую"}},
]

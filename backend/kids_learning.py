...
KIDS_HADITHS = [
    {"id": 1, "category": "kindness", "emoji": "💖",
     ...
     "sv": "De barmhärtiga visas barmhärtighet av den Barmhärtige. Var barmhärtiga mot dem på jorden och Den i himlen kommer att vara barmhärtig mot er",
     "nl": "De barmhartigen wordt barmhartigheid getoond door de Barmhartige. Wees barmhartig voor degenen op aarde en Degene in de hemel zal barmhartig zijn voor jullie",
     "el": "Στους ελεήμονες δείχνει έλεος ο Ελεήμων. Δείξτε έλεος σε αυτούς στη γη και Εκείνος στον ουρανό θα δείξει έλεος σε εσάς",
    ...
    {"id": 3, "category": "smile", "emoji": "😊",
     ...
     "sv": "Ditt leende till din broder är en välgörenhet",
     "nl": "Je glimlach naar je broeder is een liefdadigheid",
     "el": "Το χαμόγελό σου στον αδελφό σου είναι ελεημοσύνη",
    ...
    {"id": 7, "category": "knowledge", "emoji": "📖",
     ...
     "sv": "Att söka kunskap är en plikt för varje muslim",
     "nl": "Het zoeken van kennis is een plicht voor elke moslim",
     "el": "Η αναζήτηση γνώσης είναι υποχρέωση κάθε μουσουλμάνου",

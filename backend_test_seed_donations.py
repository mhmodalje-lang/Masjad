...
BACKEND_URL = "https://content-translation-1.preview.emergentagent.com/api"
...
def main():
    ...
    log("Backend URL: https://content-translation-1.preview.emergentagent.com", Colors.CYAN)
    log("="*80, Colors.BLUE)

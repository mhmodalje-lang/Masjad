...
BACKEND_URL = "https://app-stability-check-1.preview.emergentagent.com/api"
...
def main():
    ...
    log("Backend URL: https://app-stability-check-1.preview.emergentagent.com", Colors.CYAN)
    log("="*80, Colors.BLUE)

...
BACKEND_URL = "https://structured-learning-3.preview.emergentagent.com/api"
...
def main():
    ...
    log("Backend URL: https://structured-learning-3.preview.emergentagent.com", Colors.CYAN)
    log("="*80, Colors.BLUE)
